...
public class SerialDeleteButton extends Button {
    private Activity self;
    public SerialDeleteButton(Context context) {
        super(context);
        self=(Activity)context;
        addListener();
    }

    public SerialDeleteButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        self=(Activity)context;
        addListener();
    }

    public SerialDeleteButton(Context context, AttributeSet attrs, int defStyleAttr) {
